...
"""Run Algorandscout as a service: ``python -m algorandscout``."""
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="algorandscout", description="Algorandscout — an explorer API for Algorand")
